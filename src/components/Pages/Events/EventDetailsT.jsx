...
const EventDetailsT = () => {
  ...
  const eventdetailsData = [
    {
      title: "Event Helded",
      subtitle: "Choosing the Right payment  solution for your business",
      ...
      <div className="bg-white w-11/12 mx-auto  border rounded py-6  shadow-md">
        ...
        <div className=" md:w-11/12 mx-auto">
          <table className="w-full bg-white rounded shadow ">
            ...
            <tbody>
              {eventdetailsData.map((val, index) => (
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white flex flex-col gap-4  p-6 rounded-lg w-96 transform transition-all duration-500 ease-out scale-90 opacity-0 animate-popup">
                <h2 className="text-xl font-semibold ">
                  {eventdetailsData[previewIndex].title}
                </h2>
                <h2 className=" ">{eventdetailsData[previewIndex].subtitle}</h2>
                <p className=" ">
                  {eventdetailsData[previewIndex].description}
                </p>
